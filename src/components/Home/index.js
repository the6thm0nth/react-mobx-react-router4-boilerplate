    ...
    <div className="page home">
      <header>
        ...
        <div className="hero-subunit">
          <h4>
            A simple starting point for React with routing, data-fetching and
            state management!
          </h4>
        </div>
      ...
      <main>
        ...
        <div className="boilerplate-item">
          ...
          <div className="boilerplate-item-content">
            <a href="http://mobxjs.github.io/mobx/" target="_blank">
              <h4>MobX</h4>
            </a>
        ...
        <div className="boilerplate-item">
          ...
          <div className="boilerplate-item-content">
            <a href="https://react-router.now.sh/" target="_blank">
              <h4>React Router 4</h4>
            </a>
            <small>Routing Library</small>
            <p>
              React Router is a declarative way to render, at any location, any
              UI that you and your team can think up.
            </p>
          </div>
        </div>
        <div className="boilerplate-item">
